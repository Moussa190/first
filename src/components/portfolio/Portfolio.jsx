          ...
          <div className="row no-gutters">
            ...
            <div className="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch" data-aos="fade-left" data-aos-delay={100}>
              <div className="content d-flex flex-column justify-content-center">
                ...
                <p>Planen Sie einen Umzug? Lassen Sie uns Ihnen helfen! Unsere erfahrene Umzugsfirma bietet Ihnen einen zuverlässigen und professionellen Service für Ihren reibungslosen Umzug.</p>
                <div className="row">
                  <div className="col-md-6 d-md-flex align-items-md-stretch">
                    <div className="count-box">
                      ...
                      <p><strong>Erfahrene und freundliche Mitarbeiter,</strong> die Ihre Bedürfnisse verstehen.</p>
                    </div>
                  </div>
                  <div className="col-md-6 d-md-flex align-items-md-stretch">
                    <div className="count-box">
                      ...
                      <p><strong>Sorgfältige</strong> Handhabung Ihrer persönlichen Gegenstände.</p>
                    </div>
                  </div>
                  <div className="col-md-6 d-md-flex align-items-md-stretch">
                    <div className="count-box">
                      ...
                      <p><strong>Pünktlichkeit</strong> und Zuverlässigkeit in unserem Service.</p>
                    </div>
                  </div>
                  <div className="col-md-6 d-md-flex align-items-md-stretch">
                    <div className="count-box">
                      ...
                      <p><strong>Maßgeschneiderte Lösungen</strong>, die Ihren Anforderungen gerecht werden.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="testimonial-item">
                  ...
                  <p><i className="bx bxs-quote-alt-left quote-icon-left" />Von der Planung bis zur Ausführung kümmern wir uns um jeden Schritt Ihres Umzugsprozesses, damit Sie sich entspannt zurücklehnen können. Kontaktieren Sie uns jetzt für ein unverbindliches Angebot und lassen Sie uns Ihren Umzug stressfrei gestalten!<i className="bx bxs-quote-alt-right quote-icon-right" /></p>
                </div>
              </div>
            </div>
          </div>
